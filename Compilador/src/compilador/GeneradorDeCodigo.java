...
public class GeneradorDeCodigo {
    ...
    private byte[] memoria;  // Memoria
    private String elInombrable; // Nombre del Archivo
    private int topeMemoria;
    private DataOutputStream d;

    public GeneradorDeCodigo(String elInombrable, IndicadorDeErrores secuazErroneo) {
        memoria = new byte[TOPE_MEMORIA_MAX];
        cargarBloqueFijo();
        topeMemoria = TOPE_MEMORIA_INICIAL;
        this.elInombrable = elInombrable;
    }

    public void volcar() {
        try {
            FileOutputStream f = new FileOutputStream(elInombrable);
            BufferedOutputStream b = new BufferedOutputStream(f);
            d = new DataOutputStream(b);
            for (int i = 0; i < topeMemoria; i++) {
                d.writeByte(memoria[i]);
            }
            d.close();
    ...
    public void cargarEntero(int e) {
        for (int i = 0; i < 4; i++) {
            cargarByte(e & 0xFF);
            e = e >> 8;
        }
    ...
    public void cargarEnteroEn(int e, int pos) {
        for (int i = 0; i < 4; i++) {
            cargarByteEn(e & 0xFF, pos + i);
            e = e >> 8;
        }
    }

    public void apocalipsisFixUP(int contVar) { //fixUpFinal
        cargarByte(JMP_OPCODE);
        cargarEntero(0x588 - (topeMemoria + 4)); //Fin del programa
        cargarEnteroEn(descargarEnteroVon(212) + descargarEnteroVon(204) + topeMemoria - TAMAÑO_HEADER, 1793);
        for (int i = 0; i < contVar; i++) {
            cargarByte(0x00);
        } 
        cargarEnteroEn(topeMemoria - TAMAÑO_HEADER, 0x01A0);
        int fileAlignment = descargarEnteroVon(220);
        while (topeMemoria % fileAlignment != 0) {
            cargarByte(0x00);
        }
        int sizeOfCodeSection = topeMemoria - TAMAÑO_HEADER;
        int sizeOfRawData = topeMemoria - TAMAÑO_HEADER;
        cargarEnteroEn(sizeOfCodeSection, 188);
        cargarEnteroEn(sizeOfRawData, 424);
        int sectionAlignment = descargarEnteroVon(216);
        cargarEnteroEn((2 + sizeOfCodeSection / sectionAlignment) * sectionAlignment, 240);
    ...
    public int getUbicacionCadena() {
        return descargarEnteroVon(212) + descargarEnteroVon(204) + topeMemoria - TAMAÑO_HEADER + 15;
    }
    ...
    private void cargarBloqueFijo() {
        ...
        memoria[72] = 0x21;
        memoria[73] = (byte) MOV_EAX_CONST_OPCODE; // MOV AX,4C01
        memoria[74] = 0x01;
        memoria[75] = 0x4C;
 ...
 /* (For image files, it is required) */
        ...
        memoria[254] = 0x00; // DLL char theMemorizatorInator[255] = 0x00; // teristics
 ...
 /* FIRST ENTRY: TEXT HEADER */
        ...
        memoria[627] = (byte) JE_OPCODE;
        memoria[628] = (byte) PUSH_EAX_OPCODE;
        ...
        memoria[640] = (byte) JE_OPCODE;
        memoria[641] = (byte) 0x53;
        memoria[642] = (byte) JE_OPCODE;
        ...
        memoria[720] = (byte) PUSH_EAX_OPCODE;
        ...
        memoria[861] = (byte) PUSH_EAX_OPCODE;
        ...
        memoria[1248] = (byte) IDIV_OPCODE;
        memoria[1249] = (byte) IDIV_OPCODE2;
        memoria[1250] = (byte) 0x52;
        memoria[1251] = (byte) CALL_OPCODE;
        memoria[1252] = (byte) 0x18;
        memoria[1253] = (byte) 0xFF;
        memoria[1254] = (byte) 0xFF;
        memoria[1255] = (byte) 0xFF;
        memoria[1256] = (byte) POP_EAX_OPCODE;
        ...
        memoria[1267] = (byte) IDIV_OPCODE;
        memoria[1268] = (byte) IDIV_OPCODE2;
        memoria[1269] = (byte) 0x52;
        memoria[1270] = (byte) CALL_OPCODE;
        memoria[1271] = (byte) 0x05;
        memoria[1272] = (byte) 0xFF;
        memoria[1273] = (byte) 0xFF;
        memoria[1274] = (byte) 0xFF;
        memoria[1275] = (byte) POP_EAX_OPCODE;
        ...
        memoria[1286] = (byte) IDIV_OPCODE;
        memoria[1287] = (byte) IDIV_OPCODE2;
        memoria[1288] = (byte) 0x52;
        memoria[1289] = (byte) CALL_OPCODE;
        memoria[1290] = (byte) 0xF2;
        memoria[1291] = (byte) 0xFE;
        memoria[1292] = (byte) 0xFF;
        memoria[1293] = (byte) 0xFF;
        memoria[1294] = (byte) POP_EAX_OPCODE;
        ...
        memoria[1305] = (byte) IDIV_OPCODE;
        memoria[1306] = (byte) IDIV_OPCODE2;
        memoria[1307] = (byte) 0x52;
        memoria[1308] = (byte) CALL_OPCODE;
        memoria[1309] = (byte) 0xDF;
        memoria[1310] = (byte) 0xFE;
        memoria[1311] = (byte) 0xFF;
        memoria[1312] = (byte) 0xFF;
        memoria[1313] = (byte) POP_EAX_OPCODE;
        ...
        memoria[1322] = (byte) ADD_OPCODE;
        memoria[1323] = (byte) 0x00;
        memoria[1324] = (byte) IDIV_OPCODE;
        memoria[1325] = (byte) IDIV_OPCODE2;
        memoria[1326] = (byte) 0x52;
        memoria[1327] = (byte) CALL_OPCODE;
        memoria[1328] = (byte) 0xCC;
        memoria[1329] = (byte) 0xFE;
        memoria[1330] = (byte) 0xFF;
        memoria[1331] = (byte) 0xFF;
        memoria[1332] = (byte) POP_EAX_OPCODE;
        ...
        memoria[1343] = (byte) IDIV_OPCODE;
        memoria[1344] = (byte) IDIV_OPCODE2;
        memoria[1345] = (byte) 0x52;
        memoria[1346] = (byte) CALL_OPCODE;
        memoria[1347] = (byte) 0xB9;
        memoria[1348] = (byte) 0xFE;
        memoria[1349] = (byte) 0xFF;
        memoria[1350] = (byte) 0xFF;
        memoria[1351] = (byte) POP_EAX_OPCODE;
        ...
        memoria[1381] = (byte) IDIV_OPCODE;
        memoria[1382] = (byte) IDIV_OPCODE2;
        memoria[1383] = (byte) 0x52;
        memoria[1384] = (byte) CALL_OPCODE;
        memoria[1385] = (byte) XCHG_OPCODE;
        memoria[1386] = (byte) 0xFE;
        memoria[1387] = (byte) 0xFF;
        memoria[1388] = (byte) 0xFF;
        memoria[1389] = (byte) POP_EAX_OPCODE;
        ...
        memoria[1400] = (byte) IDIV_OPCODE;
        memoria[1401] = (byte) IDIV_OPCODE2;
        memoria[1402] = (byte) 0x52;
        memoria[1403] = (byte) CALL_OPCODE;
        memoria[1404] = (byte) 0x80;
        memoria[1405] = (byte) 0xFE;
        memoria[1406] = (byte) 0xFF;
        memoria[1407] = (byte) 0xFF;
        memoria[1408] = (byte) POP_EAX_OPCODE;
        memoria[1409] = (byte) CALL_OPCODE;
        memoria[1410] = (byte) JP_OPCODE;
        memoria[1411] = (byte) 0xFE;
        memoria[1412] = (byte) 0xFF;
        memoria[1413] = (byte) 0xFF;
        memoria[1414] = (byte) RET_OPCODE;
        ...
        memoria[1592] = (byte) CALL_OPCODE;
        memoria[1593] = (byte) RET_OPCODE;
        memoria[1594] = (byte) 0xFD;
        memoria[1595] = (byte) 0xFF;
        memoria[1596] = (byte) 0xFF;
        memoria[1597] = (byte) POP_EBX_OPCODE;
        memoria[1598] = (byte) 0x59;
        memoria[1599] = (byte) JMP_OPCODE;
        ...
        memoria[1687] = (byte) JGE_OPCODE;
        memoria[1688] = (byte) 0x08;
        memoria[1689] = (byte) NEG_OPCODE;
        memoria[1690] = (byte) NEG_OPCODE2;
        memoria[1691] = (byte) IDIV_OPCODE;
        memoria[1692] = (byte) 0xF9;
        memoria[1693] = (byte) NEG_OPCODE;
        memoria[1694] = (byte) NEG_OPCODE2;
        memoria[1695] = (byte) 0xEB;
        memoria[1696] = (byte) 0x02;
        memoria[1697] = (byte) IDIV_OPCODE;
        memoria[1698] = (byte) 0xF9;
        memoria[1699] = (byte) MOV_VAR_EAX_OPCODE;
